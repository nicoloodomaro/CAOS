...
#include "FreeRTOS.h"
#include "task.h"
/* Optional timeline kernel hook from port layer. Define TIMELINE_CALL_FROM_PORT
 * in your FreeRTOSConfig.h to enable direct calls from the port's tick ISR. */
...
static void prvTickISR( void )
{
    ...
    #if ( configNUMBER_OF_CORES == 1 )
    {
...
#ifdef TIMELINE_CALL_FROM_PORT
        {
            ...
            /* Allow timeline to react to the tick from the port. The
             * timeline may request a context switch by setting
